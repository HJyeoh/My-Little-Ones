    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/boy_clothes" element={<ShopCategory banner={boy_clothes_banner} category="boy_clothes" />} />
          <Route path="/girl_clothes" element={<ShopCategory banner={girl_clothes_banner} category="girl_clothes" />} />
          <Route path="/newborn_clothes" element={<ShopCategory banner={newborn_clothes_banner} category="newborn_clothes" />} />
          ...
          <Route path="/feeding" element={<ShopCategory banner={feeding_banner} category="feeding" />} />
          <Route path="/maternity_care" element={<ShopCategory banner={maternity_care_banner} category="maternity_care" />} />
